...
import {
  initInventory as initInventoryDB, getPlayerData, savePlayer, initNewPlayer, migrateFromLocalStorage, getLootTable, getWeek, saveWeek, deletePlayer
} from '../firebase/db.js';
...
async function _onUserLogin(user) {
  try {
    ...
    let player = await getPlayerData(user.uid);
